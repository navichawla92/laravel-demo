<?php
   ...
   ?>
<div class="modal fade adddocumentdocuments" id="add_new_type2" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   {!! Form::open(['id' => 'add_new_type2_form']) !!}
   <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
   <input type="hidden" name="type" value="pcp">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <div class="headingpage"> Add New Type2 </div>
               ...
               <div class="row">
                  <div class="col-6">
                     <div class="textfieldglobal">
                        ...
                        {!! Form::text('org_name',null,['maxlength'=>'60']) !!}
                  ...
                  <div class="col-6">
                     ...
                     <div class="textfieldglobal">
                      ...
                      <div class="textfieldglobal">
                        <label class="labelfieldsname add_type2_person_contact_name" > {{trans('label.contact_person_name')}} </label>
                        {!! Form::text('contact_name',null,['maxlength'=>'60']) !!}
                        <span class="error" style="color:red"></span>
                     </div>
                     <div class="textfieldglobal">
                        <label class="labelfieldsname add_type2_person_contact_phone" > {{trans('label.contact_person_phone')}} </label>
                        <div class="clearfix"></div>
                        <div class="row">
                           <div class="col-md-2">
                              {!! Form::text('phone_code','+1',['class' => 'phone_number_class','disabled'=>true]) !!} 
                      ...
                      <div class="textfieldglobal">
                        <label class="labelfieldsname add_type2_person_contact_title" > {{trans('label.contact_person_title')}} </label>
                        {!! Form::text('contact_title',null,['maxlength'=>'10']) !!}
                        <span class="error" style="color:red"></span>
                     </div>
                      <div class="textfieldglobal">
                        <label class="labelfieldsname add_type2_person_contact_email" > {{trans('label.contact_person_email')}} </label>
         ...
         <div class="modal-footer">
            <div class="buttonsbottom">
               <button type="button" class="next model_box_save" onClick="javascript:addNewType2('add_new_type2')"> {{trans('label.save')}} </button>
